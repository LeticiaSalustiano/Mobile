...
class App extends Component {
 ...
 calcular = () => {
    ...
    if (alcool && gasolina) {
        ...
        this.setState({ visibModal: true, resultado });
    }
};
 ...
 render(){
  return(
    <View style={estilos.container}>
      ...
      <TouchableOpacity 
            ...
            style={{backgroundColor: 'red', padding: 10, borderRadius: 5, marginTop: 50, width: 200, height: 45,}}>
  ...
  <View style={{flex:1, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)'}}>
    <View style={{backgroundColor: '#909090', padding: 20, borderRadius: 10, width: 300, height: 400}}>
      <Text style={{fontFamily: 'Arial', fontSize: 30, textAlign: 'center', color:'#00FF00', marginBottom: 20, marginTop: 50}}>
        {this.state.resultado}
      </Text>
      <Text style={estilos.titulo3}>Com os preços:</Text>
      <Text style={{fontSize: 19, textAlign: 'center', marginBottom: 20, marginTop: 20, color: '#fff'}}>
        Álcool: R$ {this.state.alcool}
      </Text>
      <Text style={{fontSize: 18, textAlign: 'center', marginBottom: 15, color: '#fff',}}>
        Gasolina: R$ {this.state.gasolina}
      </Text>

      <TouchableOpacity
          onPress={() => this.setState({ visibModal: false })}
          style={{backgroundColor: 'red', padding: 10, alignSelf: 'center', borderRadius: 5, marginTop: 40,}}>
    ...
    render(){
      ...
      return(
        <Image source={{uri:imagem}} 
           style={{width:150, height:150, marginTop: 90, alignSelf: 'center', marginLeft: 40 }}>
        </Image>
      )
    }
  }